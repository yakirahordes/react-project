    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <input value={address.street} onChange={
                (e) => setAddress(prev => ({ ...prev, street: e.target.value }))
            }
            />
            <label>suite:</label>
            <input value={address.suite} onChange={
                (e) => setAddress(prev => ({ ...prev, suite: e.target.value }))
            }
            />
            <label>city:</label>
            <input value={address.city} onChange={
                (e) => setAddress(prev => ({ ...prev, city: e.target.value }))
            }
            />
